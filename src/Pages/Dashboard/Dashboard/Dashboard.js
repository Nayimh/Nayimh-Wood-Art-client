...
const Dashboard = (props) => {
    ...
    const drawer = (
      <div>
            ...
            <ListItem>
            <Link className='dashLink' to={`/dashboard/makeAdmin`}><p style={{color: '#000', letterSpacing: '1px', }}>Make Admin <RiAdminFill/> </p></Link>
                
            </ListItem>
            <ListItem>
            <Link className='dashLink' to={`/dashboard/manageAllProduct`}><p style={{color: '#000', letterSpacing: '1px'}}>MANAGE PRODUCTS <MdManageAccounts/> </p></Link>
                
            </ListItem>
            <ListItem>
            <Link className='dashLink' to={`/dashboard/manageAllOrders`}><p style={{color: '#000', letterSpacing: '1px'}}>MANAGE All ORDERS <MdManageAccounts/> </p></Link>
                
            </ListItem>
           
            <ListItem>
            <Link className='dashLink' to={`/dashboard/addNewProduct`}><p style={{color: '#000', letterSpacing: '1px'}}>ADD NEW PODUCTS <MdAddShoppingCart/> </p></Link>
